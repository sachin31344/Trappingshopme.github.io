...
CREATE TABLE `tbl_country` (
  ...
  `country_name` text(100) NOT NULL DEFAULT ''
...
CREATE TABLE `tbl_customer` (
  ...
  `cust_name` text(100) NOT NULL,
  `cust_cname` text(100) NOT NULL,
  `cust_email` text(100) NOT NULL,
  `cust_phone` text(50) NOT NULL,
  `cust_country` int(11) NOT NULL,
  `cust_address` text NOT NULL,
  `cust_city` text(100) NOT NULL,
  `cust_state` text(100) NOT NULL,
  `cust_zip` text(30) NOT NULL,
  `cust_b_name` text(100) NOT NULL,
  `cust_b_cname` text(100) NOT NULL,
  `cust_b_phone` text(50) NOT NULL,
  `cust_b_country` int(11) NOT NULL,
  `cust_b_address` text NOT NULL,
  `cust_b_city` text(100) NOT NULL,
  `cust_b_state` text(100) NOT NULL,
  `cust_b_zip` text(30) NOT NULL,
  `cust_s_name` text(100) NOT NULL,
  `cust_s_cname` text(100) NOT NULL,
  `cust_s_phone` text(50) NOT NULL,
  `cust_s_country` int(11) NOT NULL,
  `cust_s_address` text NOT NULL,
  `cust_s_city` text(100) NOT NULL,
  `cust_s_state` text(100) NOT NULL,
  `cust_s_zip` text(30) NOT NULL,
  `cust_password` text(100) NOT NULL,
  `cust_token` text(255) NOT NULL,
...
CREATE TABLE `tbl_page` (
  `id` int(11) NOT NULL,
  `about_title` text(255) NOT NULL,
  `about_content` text NOT NULL,
  `about_banner` text(255) NOT NULL,
  `about_meta_title` text(255) NOT NULL,
  `about_meta_keyword` text NOT NULL,
  `about_meta_description` text NOT NULL,
  `faq_title` text(255) NOT NULL,
  `faq_banner` text(255) NOT NULL,
  `faq_meta_title` text(255) NOT NULL,
  `faq_meta_keyword` text NOT NULL,
  `faq_meta_description` text NOT NULL,
  `blog_title` text(255) NOT NULL,
  `blog_banner` text(255) NOT NULL,
  `blog_meta_title` text(255) NOT NULL,
  `blog_meta_keyword` text NOT NULL,
  `blog_meta_description` text NOT NULL,
  `contact_title` text(255) NOT NULL,
  `contact_banner` text(255) NOT NULL,
  `contact_meta_title` text(255) NOT NULL,
  `contact_meta_keyword` text NOT NULL,
  `contact_meta_description` text NOT NULL,
  `pgallery_title` text(255) NOT NULL,
  `pgallery_banner` text(255) NOT NULL,
  `pgallery_meta_title` text(255) NOT NULL,
  `pgallery_meta_keyword` text NOT NULL,
  `pgallery_meta_description` text NOT NULL,
  `vgallery_title` text(255) NOT NULL,
  `vgallery_banner` text(255) NOT NULL,
...
CREATE TABLE `tbl_payment` (
  ...
  `payment_date` text(50) NOT NULL,
  `txnid` text(255) NOT NULL,
  `paid_amount` int(11) NOT NULL,
  `card_number` text(50) NOT NULL,
  `card_cvv` text(10) NOT NULL,
  `card_month` text(10) NOT NULL,
  `card_year` text(10) NOT NULL,
...
CREATE TABLE `tbl_post` (
  ...
  `post_title` text(255) NOT NULL,
  `post_slug` text(255) NOT NULL,
  `post_content` text NOT NULL,
  `post_date` text(255) NOT NULL,
  `photo` text(255) NOT NULL,
...
CREATE TABLE `tbl_product` (
  ...
  `p_name` text(255) NOT NULL,
  `p_old_price` text(10) NOT NULL,
  `p_current_price` text(10) NOT NULL,
  `p_qty` int(10) NOT NULL,
  `p_featured_photo` text(255) NOT NULL,
...
CREATE TABLE `tbl_subscriber` (
  ...
  `subs_email` text(255) NOT NULL,
  `subs_date` text(100) NOT NULL,
